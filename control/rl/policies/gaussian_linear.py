...
class LinearPolicy:
    def __init__(self, env_spec, bias=True, min_log_std=-3, init_log_std=0, seed=None):
        """
        ...
        # Policy network
        # ------------------------
        self.model = FCNetwork(self.n, self.m, hidden_sizes=(), bias=bias)
        # make weights small
        ...
        # Old Policy network
        # ------------------------
        self.old_model = FCNetwork(self.n, self.m, hidden_sizes=(), bias=bias)
