...
//			cout << "Flowpipe taylor remainder: " << initial_set.tmv.tms[0].remainder << "     " << initial_set.tmv.tms[1].remainder << endl;
	...
	plot_setting.plot_2D_interval_GNUPLOT("./outputs/", benchmark_name + "_" + to_string(if_symbo) + "_x0", result.tmv_flowpipes, setting);
	plot_setting.setOutputDims("t", "x1");
	plot_setting.plot_2D_interval_GNUPLOT("./outputs/", benchmark_name + "_" + to_string(if_symbo) + "_x1", result.tmv_flowpipes, setting);
