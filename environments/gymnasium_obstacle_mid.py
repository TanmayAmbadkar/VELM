...
class Gymnasium_ObstacleMidEnv(gym.Env):
    def __init__(self):
        super().__init__()
...
class GymnasiumObstacleMid:

    environment_name = "gymnasium_obstacle_mid"
    entry_point = "environments.gymnasium_obstacle_mid:Gymnasium_ObstacleMidEnv"
    ...
    def __init__(self, **kwargs):
        ...
        GymnasiumObstacleMid.version += 1
        self._config = config
