...
class Gymnasium_NoisyRoad2DEnv(gym.Env):
    def __init__(self):
        super().__init__()
...
class GymnasiumNoisyRoad2D:

    environment_name = "gymnasium_noisy_road_2d"
    entry_point = "environments.gymnasium_noisy_road_2d:Gymnasium_NoisyRoad2DEnv"
    ...
    def __init__(self, **kwargs):
        ...
        GymnasiumNoisyRoad2D.version += 1
        self._config = config
