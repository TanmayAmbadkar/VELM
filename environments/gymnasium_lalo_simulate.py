...
class Gymnasium_LaloSimulateEnv(gym.Env):
    def __init__(self, learned_model: List[str] = []):
        super(Gymnasium_LaloSimulateEnv, self).__init__()
...
class Gymnasium_LaloSimulate:

    environment_name = "gymnasium_lalo_simulate"
    entry_point = "environments.gymnasium_lalo_simulate:Gymnasium_LaloSimulateEnv"
    ...
    def __init__(self, **kwargs):
        ...
        Gymnasium_LaloSimulate.version += 1
        self._config = config
