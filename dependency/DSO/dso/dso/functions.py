...
def lnot(x1):
    return np.logical_not(x1).astype(int)
...
unprotected_ops = [
    ...
    Token(land, "land", arity=2, complexity=1),
    Token(lor, "lor", arity=2, complexity=1),
    Token(lnot, "lnot", arity=1, complexity=1),
    Token(lxor, "lxor", arity=2, complexity=1)
]
