...
class CFG(object):
    ...
    def __init__(self, sy_exp):
        ...
        for se in sy_exp.get_args():
            ...
            res = []
            for prod in derivations: # each deriviation (prod) is of type class 'metal.parser.sygus_parser.SyExp'.
                # print("prod:", prod)
            ...
            self.productions[nt] = res # nt is of type class str. In the grammar, we have nt -> derivations.
