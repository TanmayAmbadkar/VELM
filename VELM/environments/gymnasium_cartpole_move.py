...
class Gymnasium_CartPoleMoveEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    metadata = {
...
class GymnasiumCartPoleMove:
    environment_name = "gymnasium_cartpole_move"
    entry_point = "environments.gymnasium_cartpole_move:Gymnasium_CartPoleMoveEnv"
    ...
    def __init__(self, **kwargs):
        ...
        GymnasiumCartPoleMove.version += 1
        self._config = config
