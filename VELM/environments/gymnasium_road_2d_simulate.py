...
class Gymnasium_Road2DSimulateEnv(gym.Env):
...
class GymnasiumRoad2DSimulate:

    environment_name = "gymnasium_road_2d_simulate"
    entry_point = "environments.gymnasium_road_2d_simulate:Gymnasium_Road2DSimulateEnv"
    ...
    def __init__(self, **kwargs):
        ...
        GymnasiumRoad2DSimulate.version += 1
        self._config = config
