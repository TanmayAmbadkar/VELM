...
class Gymnasium_CartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    metadata = {
...
class GymnasiumCartPole:
    environment_name = "gymnasium_cartpole"
    entry_point = "environments.gymnasium_cartpole:Gymnasium_CartPoleEnv"
