...
class Gymnasium_ObstacleSimulateEnv(gym.Env):
...
class GymnasiumObstacleSimulate:

    environment_name = "gymnasium_obstacle_simulate"
    entry_point = (
        "environments.gymnasium_obstacle_simulate:Gymnasium_ObstacleSimulateEnv"
    )
    ...
    def __init__(self, **kwargs):
        ...
        GymnasiumObstacleSimulate.version += 1
        self._config = config
