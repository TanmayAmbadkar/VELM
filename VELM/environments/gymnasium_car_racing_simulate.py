...
class Gymnasium_CarRacingSimulateEnv(gym.Env):
...
class GymnasiumCarRacingSimulate:

    environment_name = "gymnasium_car_racing_simulate"
    entry_point = (
        "environments.gymnasium_car_racing_simulate:Gymnasium_CarRacingSimulateEnv"
    )
    ...
    def __init__(self, **kwargs):
        ...
        GymnasiumCarRacingSimulate.version += 1
        self._config = config
